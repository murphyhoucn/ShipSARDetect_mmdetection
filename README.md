...
Run for Faster R-CNN : python tools\train.py configs\ssdd\faster_rcnn_r50_fpn_ssdd.py
...
python tools\train.py configs\faster_rcnn\faster_rcnn_r50_fpn_ssdd.py
